...
void visCallback(const ros::TimerEvent& e) {
  displayTrajWithColor(traj_real_, 0.1, Eigen::Vector4d(0.925, 0.054, 0.964, 1), 1);
...
int main(int argc, char** argv) {
  ...
  std::string traj_real_file_path = file_path + "Utils/traj_analysis/traj_real.txt";
  std::string traj_cmd_file_path = file_path + "Utils/traj_analysis/traj_cmd.txt";
