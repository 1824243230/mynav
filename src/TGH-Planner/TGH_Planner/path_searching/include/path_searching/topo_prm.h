...
private:
  ...
  void publishGuidePath(const std::vector<Eigen::Vector3d>& path_nodes);
...
public:
  ...
  vector<vector<Eigen::Vector3d>> getVoroPathsForPub() {
    return short_paths_;
  }
  ...
  void checkPathObstacle3(const int& path_id, const bool& inFront);
